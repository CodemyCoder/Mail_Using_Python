...
msg = EmailMessage()
msg["From"] = User
msg["To"] = User # Can be used to send same mail to multiple users (Including You Also)
...
for fileName in FILELIST:
    ...
    if os.path.isfile(filePath):
        ...
        if fileSize > float(20):
            print(fileName, "Can't Be Uploaded As The Size Is Greater Than 20Mb") # To inform the user that file size is greater than 20MB
        else:
            fileAttach = open(filePath, "rb").read()
            customName = "CodemyCoder" + "." + fileName.split(".")[1] # You can replace CodemyCoder with any name you want or can build your own logic as you want
